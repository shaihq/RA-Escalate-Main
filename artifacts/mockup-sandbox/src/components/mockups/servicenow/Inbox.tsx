      ...
      <header className="flex items-center h-11 bg-[#1a3a3a] text-white px-3 gap-4 shrink-0">
        ...
        <nav className="flex items-center gap-0.5 text-xs text-gray-300">
          {["All", "Favorites", "History", "Workspaces", "Studio"].map((item) => (
            <Button
              ...
              variant="ghost"
              size="sm"
              className="h-7 px-2.5 text-xs text-gray-300 hover:text-white hover:bg-white/10"
            >
              {item}
            </Button>
          ))}
        ...
        <div className="flex-1 flex justify-center">
          <Button
            variant="ghost"
            size="sm"
            className="h-7 px-3 text-xs text-gray-200 hover:text-white hover:bg-white/10 gap-1.5 border border-white/20"
          >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="h-7 w-7 rounded-full bg-orange-400 flex items-center justify-center text-xs font-semibold text-white cursor-pointer">
              A
            </div>
          </div>
        </div>
